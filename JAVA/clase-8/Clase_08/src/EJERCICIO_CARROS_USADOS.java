...
//mensuales, mas una comision del $150 por cada carro vendido, mas el 5% del valor de la 
//venta por carro. Cada mes el capturista de la empresa ingresa en la computadora los datos
//pertinentes

//Hacer un programa que calcule e imprima el salario mensual de un vendedor dado.
//El salario de 1000 lo vamos a manejar como un dato constante, para asignarlo debemos usar
//la palabra reservada "final"

import java.util.Scanner;

public class EJERCICIO_CARROS_USADOS {
